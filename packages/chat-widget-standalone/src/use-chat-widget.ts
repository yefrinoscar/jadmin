...
export interface UseChatWidgetOptions {
  /** URL del backend de JAdmin (ej: https://jadmin.tudominio.com) */
  apiUrl: string;
  /** URL de Supabase (opcional, se obtiene del API si no se provee) */
  supabaseUrl?: string;
  /** Anon Key de Supabase (opcional, se obtiene del API si no se provee) */
  supabaseAnonKey?: string;
  /** Callback cuando llega un nuevo mensaje */
  onNewMessage?: (message: ChatMessage) => void;
  /** Callback cuando ocurre handoff AI->Humano */
  onHandoff?: (managedBy: "ai" | "human") => void;
  /** Key para localStorage (default: jadmin_chat_conversation_id) */
  storageKey?: string;
}
